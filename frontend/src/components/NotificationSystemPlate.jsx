...
const RuleInput = ({
  ...
  const commonClasses = `w-full rounded-xl px-4 py-3 pl-10 text-sm font-black border outline-none transition-all focus:border-blue-500/50 appearance-none ${themeClasses.input}`;
...
const NotificationSystemPlate = ({
  ...
  const themeClasses = {
    bg: isDark ? "bg-[#050505]" : "bg-slate-100",
    card: isDark
      ? "bg-[#0A0A0A] border-white/5 text-white"
      : "bg-white border-slate-200 text-slate-900",
    input: isDark
      ? "bg-black/40 border-white/10 text-white focus:border-blue-600/50"
  ...
  return (
    <div
      className={`flex items-center justify-start font-sans transition-colors duration-500 ${themeClasses.bg}`}
    >
      <div className="w-full h-auto relative animate-in fade-in duration-500">
        <div
          className={`p-8 rounded-[2.5rem] border transition-all relative overflow-hidden h-auto flex flex-col shadow-2xl ${themeClasses.card} ${isStartedSending ? "opacity-40 pointer-events-none" : "opacity-100"}`}
        >
          <div className="grid grid-cols-12 gap-8 items-start flex-1">
            ...
            <div className="col-span-12 lg:col-span-3 space-y-2">
              ...
              {(activeSettings === "startgg" ||
                activeSettings === "challonge") && (
                <section
                ...
                >
                  <div className="flex items-center justify-between border-b pb-2 border-current/5">
                    <h4 className="text-[9px] font-black uppercase text-amber-500 italic">
                      Параметры получения ({activeSettings})
                    </h4>
                    <button
            ...
            <div className="col-span-12 lg:col-span-9 grid grid-cols-12 gap-8">
              <div className="col-span-12 lg:col-span-7 space-y-6">
                  ...
                  <div className="w-[180px] space-y-1">
                    ...
                    <div className="relative flex items-center">
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          updateConfig("tournament", {
                            game: { ...tourneyCfg.game, name: e.target.value },
                          })
                        }
                      >
                ...
                >
                      ...
                      <div className="animate-in fade-in slide-in-from-right-2 duration-300 space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          ...
                          <div className="space-y-1.5">
                            ...
                            >
                              ...
                              <option value="LAN">только LAN (прямое)</option>
                            </select>
                          </div>
                        ...
                        <div className="space-y-1.5 pt-2">
                          <label
                            className={`text-[9px] font-black uppercase flex items-center gap-2 ${themeClasses.textMuted}`}
                          >
                            <Key size={12} className="text-emerald-500" /> Код
                            доступа
                          </label>
                          <input
                            type="number"
                  ...
                  {checkInEnabled && (
                    <div
                      className={`p-4 rounded-2xl border animate-in slide-in-from-top-2 duration-300 ${isDark ? "bg-blue-600/5 border-blue-600/10" : "bg-blue-50 border-blue-100"}`}
                    >
                      <div className="flex items-center justify-between mb-2">
                        <div className="flex items-center gap-2">
                          <UserCheck size={14} className="text-blue-500" />
                          <label
                            className={`text-[9px] font-black uppercase italic ${themeClasses.textMuted}`}
                          >
                            Время ожидания
                          </label>
                        </div>
                        <span className="text-xs font-mono font-bold text-blue-500">
                          {tourneyCfg?.rules?.waiting} мин
                        </span>
                      </div>
                      <RuleInput
                        value={rules.waiting}
                ...
                >
                  ...
                  <div className="flex gap-4 items-start">
                    ...
                    <div className="flex-1 space-y-4">
                      ...
                      <div
                        className={`h-14 border-2 border-dashed rounded-2xl flex flex-col items-center justify-center text-[7px] font-black uppercase cursor-pointer hover:bg-blue-600/5 transition-all ${isDark ? "border-white/5 text-slate-500" : "border-slate-200 text-slate-400"}`}
                      >
        ...
        <div className="absolute bottom-8 right-8 z-50 flex flex-col items-end gap-3">
          {!isStartedSending && debugMode && (
            ...
            >
              ...
              <span className="text-[9px] font-bold uppercase italic tracking-tight leading-tight">
                В этом режиме сообщения приходят в ЛС вашего аккаунта{" "}
          ...
          >
            {isStartedSending ? (
              <>
                <Square fill="white" size={20} /> Остановить
              </>
            ) : (
              <>
                {debugMode ? (
                ...
                {debugMode ? "Отладка рассылки" : "Начать рассылку"}
              </>
            )}
          </button>
        </div>
